...
TSA <- read_html_live("https://www.tsa.gov/travel/passenger-volumes") %>%
...
The table on the right looks at how average screenings stack up in available data for the the month of `r format(latest$Date, "%B")` so far.
